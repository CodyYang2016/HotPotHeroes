...
namespace sprint0Test.Link1
{
    public class Link
    {
        ...
        public static Link Instance
        {
            ...
            {
                if (instance == null)
                    throw new System.InvalidOperationException("Link instance has not been initialized!");
                return instance;
            }
        }
        ...
        public static void Initialize(LinkSprite linkSprite, Vector2 startPos)
        {
            if (instance == null)
            {
                instance = new Link(linkSprite, startPos);
            }
            else
            {
                throw new System.InvalidOperationException("Link has already been initialized!");
            }
        }
        ...
        {
            return sprite.GetScaledDimensions();
        }
