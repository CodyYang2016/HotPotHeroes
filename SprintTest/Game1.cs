...
public class Game1 : Game
{
    ...
    protected override void Initialize()
    {
        ...
        base.Initialize();
        // Initialize the MasterCollisionHandler
        // masterCollisionHandler = new MasterCollisionHandler();
    }
    ...
    protected override void LoadContent()
    {
        ...
        //BlockManager.LoadTexture(dungeonTexture);
        //BlockManager.Instance.CreateBlock(new Vector2(100, 100), BlockType.Stair);
        //BlockManager.Instance.CreateBlock(new Vector2(300, 100), new Rectangle(0, 0, 16, 16));
