...
public class Game1 : Game
{
    ...
    protected override void Update(GameTime gameTime)
    {
        ...
        playerBlockCollisionHandler.HandleCollisionList(Link, blockSprites._active);
        playerEnemyCollisionHandler.HandleCollision(Link, EnemyManager.Instance.GetActiveEnemy());
        playerItemCollisionHandler.HandleCollision(Link, currentItem);
